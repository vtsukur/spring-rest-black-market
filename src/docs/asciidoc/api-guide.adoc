...
The Ads resource is used to create and list ads
...
include::{generated}/create-ad/curl-request.adoc[]

==== Example HTTP request

include::{generated}/create-ad/http-request.adoc[]

==== Example response

include::{generated}/create-ad/http-response.adoc[]
